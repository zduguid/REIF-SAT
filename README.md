<a href="https://zduguid.github.io">
    <img src="README/project_logo.jpg" alt="project_logo" align="right" height="70">
</a>


# Image Processing for RSA Telescope
The goal of this project is to demonstrate the feasibility of a Rotating Synthetic Aperture (RSA) space telescope that is capable of producing images that are equivalent in resolution to what would be produced by a circular aperture system with the same diameter lens. This project is the deliverable of MIT's Aerospace Engineering capstone course for undergraduate students: 16.83 - Space Systems Engineering. To demonstrate the feasibility of a spinning-aperture space telescope, image processing algorithms must be developed to synthesize a high resolution image from a series of individual frames.
...
## Image Processing 
To demonstrate the feasibility of the image processing software, a set of artificial frames are generated to simulate the effect of the spinning rectangular aperture system. Then, a Wiener Filter algorithm is used to reconstruct the set of frames into a high-resolution synthesized image.
...
<img src="README/frames.jpg" alt="frame_generation" align="center" width="900">
...
<img src="README/wiener_filter_results.jpg" alt="wiener_results" align="center" width="900">
...
<img src="README/image_histograms.jpg" alt="image_histograms" align="center" width="900">
...
<img src="README/image_similarity.png" alt="image_similarity" align="center" width="900">
